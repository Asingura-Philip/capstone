...
function JobSeekerDashboard() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4040/jobseeker/profile/1") // Assuming jobseeker id 1 for testing
      .then((response) => {
        setProfile({
  ...
  const handleSaveProfile = () => {
    axios
      .put("http://localhost:4040/jobseeker/profile/1", { // Assuming jobseeker id 1 for testing
